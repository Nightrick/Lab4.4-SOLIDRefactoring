...
public class Blockbuster {
	...
	public static void main(String[] args) {
		...
		if(userMovieSelection == 1) {
			((VHS) movies.get(userMovieSelection - 1)).play(peachScenes);	
		} else if (userMovieSelection == 2) {
			((VHS) movies.get(userMovieSelection - 1)).play(starWarsScenes);
		} else if (userMovieSelection == 3) {
			((VHS) movies.get(userMovieSelection - 1)).play(annieScenes);
		} else if (userMovieSelection == 4) {
			((DVD) movies.get(userMovieSelection - 1)).play(terminatorScenes);
		} else if (userMovieSelection == 5) {
			((DVD) movies.get(userMovieSelection - 1)).play(matrixScenes);
		} else if (userMovieSelection == 6) {
			((DVD) movies.get(userMovieSelection - 1)).play(avengersScenes);
		}
